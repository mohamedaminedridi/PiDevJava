...
public class ModifyVoyageController implements Initializable {
...
// Check for null values before conversion
        ...
        if (titre.isEmpty() || desc.isEmpty() || nbrPersonne.isEmpty() || prix.isEmpty()  || titre.isEmpty() || Objects.equals(Pic, "")) {
            ...
            Voyage voy = new Voyage(selectedVoyage.getId(),selectedPropriete.getId(),nbrPersonneint,Pic,desc,titre,prixint,datedebut,datefin);
            vs.update(voy);
    ...
    public void initData (Voyage v){
        ...
        titreTF.setText(v.getTitle());
        descTF.setText(v.getDescription());
        prixTF.setText(String.valueOf(v.getPrixtotal()));
        nbrPersonneTF.setText(String.valueOf(v.getNbr_personne()));
        dateFin.setValue(v.getDatefin().toLocalDate());
        dateDeb.setValue(v.getDatedebut().toLocalDate());
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        propCB.setCellFactory(cell -> new ModifyVoyageController.CategoryCellFactory());
        propCB.setConverter(new ModifyVoyageController.CategoryStringConverter());
    ...
    private static class CategoryStringConverter extends StringConverter<Propriete> {
        ...
        public String toString(Propriete propriete) {
            return propriete != null ? propriete.getImage() : null; // Convert voyage to its title
        }
